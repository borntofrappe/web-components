class TogglePassword extends HTMLElement {
  ...
  <svg data-pressed="false" width="1em" height="1em" fill="currentColor" viewBox="0 0 256 256">
    <path d="M 228 175 a 8 8 0 0 1 -10.92 -3 l -19 -33.2 a 123.23 123.23 0 0 1 -36.08 16.66 l 1.87 35.22 a 8 8 0 0 1 -6.58 9.21 a 8.4 8.4 0 0 1 -1.29 0.11 a 8 8 0 0 1 -7.88 -6.69 l -5.77 -34.58 a 133.06 133.06 0 0 1 -36.68 0 l -5.77 34.58 a 8 8 0 0 1 -7.9 6.69 a 8.4 8.4 0 0 1 -1.32 -0.11 a 8 8 0 0 1 -6.58 -9.21 l 1.9 -35.22 a 123.23 123.23 0 0 1 -36.06 -16.69 l -18.94 33.23 a 8 8 0 1 1 -13.94 -8 l 10 -35 a 153.47 153.47 0 0 1 -19.3 -20 a 8 8 0 1 1 12.46 -10c 16.6 20.54 45.64 45 89.78 45s 73.18 -24.49 89.78 -45 a 8 8 0 1 1 12.44 10 a 153.47 153.47 0 0 1 -19.3 20 l 10 35 a 8 8 0 0 1 -2.92 11 z" />
  </svg>
  <svg data-pressed="true" display="none" width="1em" height="1em" fill="currentColor" viewBox="0 0 256 256">
    ...
    const iconHidden = button.querySelector('[data-pressed="false"]');
    const iconVisible = button.querySelector('[data-pressed="true"]');
